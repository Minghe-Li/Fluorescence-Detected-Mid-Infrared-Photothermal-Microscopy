...
FilePath = 'D:\Data\Photothermal_Shared_lab\4-21-21 zscan grounded SG\'; %C:\Data\Max\20180921\PD_test_without MRA\2f_PD_no mod_cross_sin ref\'; %Always end with \
Savefile = 0;
IRChannelNumber = 97; %QCL channel number
...
%% Image Acq setup
Image_H_Pixel = 100; %100
Image_V_Pixel = 100; %100
Image_H_frequency = 1/3; % in Hz, 1/3
Image_V_frequency = Image_H_frequency/Image_V_Pixel; %Image_H_frequency*1/Image_V_Pixel; % in Hz
offset = 33679; %480 for 8/10V and 600 for 4/5V
                 
%% AlazarCard Setup
Sampling_Rate = 1; %0 for 20KSPS 1 for 50KSPS; 2 for 1MSPS; 3 for 25 MSPS; 4 for 50 MSPS; 5 for 100 MSPS;

% Channel Input Ranges.  
% 0 for +- 200mV        2 for +- 1V 
% 1 for +- 400mV        3 for +- 2V
% 4 for +- 4V           5 for +- 800mv
ChannelARange = 1; %0 for HWP rotation, 4 for LIA
ChannelBRange = 4; 
ChannalAImpedances = 0; %0 for 50 ohms. 1 for 1 Mohms.
ChannalBImpedances = 0; %0 for 50 ohms. 1 for 1 Mohms.
External_Trigger = 1; %1
AcqParameters.Timeline = 360; %360
