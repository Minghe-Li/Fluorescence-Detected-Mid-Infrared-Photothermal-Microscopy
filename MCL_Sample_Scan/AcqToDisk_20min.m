...
Image_H_frequency = 1/6; % in Hz, 10
...
ChannelARange = 4; %0 for HWP rotation, 4 for LIA
ChannelBRange = 4; 
ChannalAImpedances = 0; %0 for 50 ohms. 1 for 1 Mohms.
ChannalBImpedances = 0; %0 for 50 ohms. 1 for 1 Mohms.
External_Trigger = 1; %1
AcqParameters.Timeline = 1450; %0
% Set up the trigger level in percent.
TriggerLevel = 20; % In percent of the input range of channal A. (-99 to 99)

% Switch for sampling rate input0
switch Sampling_Rate
    case 0
        ConfigParameters.SamplingRate = SAMPLE_RATE_1KSPS;
        ConfigParameters.GlobalSamplingRate = 1e3;%20e3;
    case 1
...
if Savefile
    saveas(gcf,['D:\Data\Photothermal\2-1-21 Silica Gel Full Spectrum\epi_fluor\epi_fluor_chan' num2str(IRChannelNumber) '_0.74gain.tif']);
end
figure;
plot(rawdata1);
...
colormap(jet);
if Savefile
    saveas(gcf,['D:\Data\Photothermal\2-1-21 Silica Gel Full Spectrum\Chan' num2str(IRChannelNumber) '_2kHz_8us_10mstc_small_area_16.5V_0.74gain.tif']);
end
figure;
plot(rawdata2);
...
if Savefile
    save(['D:\Data\Photothermal\2-1-21 Silica Gel Full Spectrum\Chan' num2str(IRChannelNumber) '_2kHz_8us_10mstc_small_area_16.5V_0.74gain_fullraw.mat'] , 'rawdata');
    save(['D:\Data\Photothermal\2-1-21 Silica Gel Full Spectrum\RawImage_Chan' num2str(IRChannelNumber) '_2kHz_8us_10mstc_small_area_16.5V_0.74gain.mat'] , 'RawImage2');
